...
const f1 = () => {
    ...
    out.textContent = a1.find((item) => item > a1_from && item < a1_to);
};
...
const f4 = () => {
    ...
    out.textContent = str4
        .split('_')
        .find(
            (item) =>
                item.indexOf(a4_from) !== -1 && item.lastIndexOf(a4_to) !== -1
        );
};
...
const f9 = () => {
    ...
    out.textContent = a9.lastIndexOf(a9_1);
};
